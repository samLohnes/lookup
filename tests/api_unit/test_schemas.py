...
def test_pass_to_response_roundtrip():
    ...
    p = Pass(
        ...
        norad_id=25544,
        name="ISS (ZARYA)",
        rise=PassEndpoint(time=t0, position=AngularPosition(30.0, 10.0), range_km=1800.0),
        peak=PassEndpoint(time=t0, position=AngularPosition(180.0, 60.0), range_km=520.0),
        set=PassEndpoint(time=t0, position=AngularPosition(300.0, 10.0), range_km=1900.0),
        duration_s=300,
        max_magnitude=-2.5,
        sunlit_fraction=0.9,
        tle_epoch=t0,
