...
def test_pass_construction():
    ...
    p = Pass(
        ...
        norad_id=25544,
        name="ISS (ZARYA)",
        rise=PassEndpoint(time=t0, position=AngularPosition(347.0, 12.0), range_km=1800.0),
        peak=PassEndpoint(time=t1, position=AngularPosition(247.3, 52.1), range_km=520.0),
        set=PassEndpoint(time=t2, position=AngularPosition(137.0, 10.0), range_km=1900.0),
        duration_s=252,
        max_magnitude=-2.8,
        sunlit_fraction=1.0,
...
def test_train_pass_construction():
    ...
    members = (
        Pass(
            ...
            norad_id=44713,
            name="STARLINK-1",
            rise=PassEndpoint(time=t0, position=AngularPosition(10.0, 10.0), range_km=1800.0),
            peak=PassEndpoint(time=t1, position=AngularPosition(180.0, 60.0), range_km=600.0),
            set=PassEndpoint(time=t2, position=AngularPosition(350.0, 10.0), range_km=1900.0),
            duration_s=300,
            max_magnitude=4.0,
            sunlit_fraction=1.0,
            tle_epoch=t0,
